...
export default function SignUp() {
  ...
  const handlesubmit = () => {
    ...
    axiosInstance.post("/api/sign-up", { name, email, password, confirmed_password: cPassword })
      .then((res) => {
    ...
    <div className='w-full h-screen flex flex-col justify-center items-center gap-10'>
      ...
      <div className='flex flex-col gap-4 w-full items-center'>
        ...
        <div className='relative rounded-md w-[300px] h-[40px] bg-[#f3f3f3] focus-within:ring-1 focus-within:ring-green-500'>
          ...
          {isHideC
            ? <img src="/eye-close.svg" alt="eye-close" width={18} height={18} className='absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer' onClick={() => setHideC(!isHideC)}/>
